...
const features = [
  ...
  },
  {
    ...
    description:
      "Kişiselleştirilmiş öğrenme deneyimi için AI destekli rehberlik.",
    icon: CogIcon,
    angle: ANGLE_STEP * 2,
    animationDelay: 2,
  },
  ...
  },
  {
    ...
    description: "Her öğrencinin seviyesine ve ilgi alanına özel içerikler.",
  ...
  },
  {
    ...
    description: "Detaylı öğrenme analitikleri ve gelişim raporları.",
    icon: ArrowPathIcon,
    angle: ANGLE_STEP * 6,
    animationDelay: 6,
  },
